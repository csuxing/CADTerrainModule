...
public:
	...
	static void AdskMyGroupCTerrain() {
		...
		CustomBoost::BoostGraphic::readHoleFileForPaint("D:\\备份\\TerrainModule\\Data\\modify\\L0_0_0", hole_pts);
		CReadSrcFile::ReadASCIIHeadfile("D:\\备份\\TerrainModule\\Data\\dem\\L0_0_0", headfile);
		CReadSrcFile::ReadASCII(vecpts, "D:\\备份\\TerrainModule\\Data\\dem\\L0_0_0");
		CReadSrcFile::ReadASCIIindex("D:\\备份\\TerrainModule\\Data\\modify\\L0_0_0_index", index);
		...
		p->setflag(1);
		AcDbObjectId id=p->createMaterial("L0", "C:/Users/xyh19/Desktop/CAD二次开发/Texture/NewData/image.jpg", 1/((headfile.ncols-1)*headfile.cellsize), 1 / ((headfile.nrows - 1)*headfile.cellsize), AcGeVector3d(1, 1, 0));
		p->setMaterial(id);
